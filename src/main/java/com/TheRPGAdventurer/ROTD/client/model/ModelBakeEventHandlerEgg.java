 ...
 */
public class ModelBakeEventHandlerEgg {
  public static final ModelBakeEventHandlerEgg instance = new ModelBakeEventHandlerEgg();

  private ModelBakeEventHandlerEgg() {};
  ...
  {
    // Find the existing mapping for DragonHatchableEggModel - we added it in StartupClientOnly.initClientOnly(), which
...
//    Object object =  event.getModelRegistry().getObject(DragonHatchableEggModel.modelResourceLocation);
//    if (object instanceof IBakedModel) {
//      IBakedModel existingModel = (IBakedModel)object;
//      DragonHatchableEggModel customModel = new DragonHatchableEggModel(existingModel);
//      event.getModelRegistry().putObject(DragonHatchableEggModel.modelResourceLocation, customModel);
//    }
  }
}
