...
public class DragonModel extends AdvancedModelBase {
  ...
  public ModelPart tailRidgePlateLeft;
  public ModelPart tailRidgePlateMiddle;
  public ModelPart tailRidgePlateRight;
  public ModelPart jaw;

  public ModelPart body;
  public ModelPart heart;
  public ModelPart bodyRidgePlateFrontmost;
...
*/
  ...
  public DragonModel(DragonPhysicalModel dragonPhysicalModel) {
    ...
    setTextureOffset("neck.ridgeplate", 0, 0);
    setTextureOffset("tail.box", 152, 88);
    setTextureOffset("tail.ridgeplate", 0, 0);
  ...
  private void buildTail() {
    ...
    tailRidgePlateLeft = tail.addChildBox("ridgeplate", -1, -8, -3, 2, 4, 6).setAngles(0, 0, scaleRotZ);
    ...
    tailRidgePlateRight.showModel = ice;
  ...
  private void buildBody() {
    ...
    body.addBox("ridgeplate", -1, -6, 10, 2, 6, 12);
    body.addBox("ridgeplate", -1, -6, 30, 2, 6, 12);
    heart = body.addChildBox("heart", -4, 12, -5, 8, 6, 15);
    bodyRidgePlateFrontmost = body.addChildBox("ridgeplate", -1, -6, -10, 2, 6, 12);
