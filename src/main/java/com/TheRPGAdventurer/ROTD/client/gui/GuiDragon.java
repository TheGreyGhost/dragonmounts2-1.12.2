...
import com.TheRPGAdventurer.ROTD.common.network.MessageDragonGuiLock;
import com.TheRPGAdventurer.ROTD.common.network.MessageDragonGuiSit;
...
/*            // Draw Player Entity
        ...
        GuiInventory.drawEntityOnScreen(x + 85, y + 65, (int) (13 / dragon.getAgeScale()), x + 51 - this.mousePosX, y + 75 - 50 - this.mousePosY,
                this.dragon);
