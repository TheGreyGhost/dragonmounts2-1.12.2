 ...
 */
@Deprecated
public class FlameBreathFX extends Entity implements IEntityParticle {
   ...
   */
  public static FlameBreathFX createFlameBreathFX(World world, double x, double y, double z, double directionX, double directionY, double directionZ, BreathNodeP.Power power, float partialTicksHeadStart, EntityTameableDragon dragon) {
