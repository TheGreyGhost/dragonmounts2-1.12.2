...
public class DragonPhysicalModel {
   ...
   */
  public float getRenderScaleFactor(float ageScale) { return CONVERT_BC_TO_WC * ageScale; }

  /**
   * The factor used to convert from model space coordinates to worldspace coordinates
   * @return
   */
  public float getConversionFactorMCtoWC(float ageScale) {return CONVERT_MC_TO_BC * CONVERT_BC_TO_WC * ageScale;}
