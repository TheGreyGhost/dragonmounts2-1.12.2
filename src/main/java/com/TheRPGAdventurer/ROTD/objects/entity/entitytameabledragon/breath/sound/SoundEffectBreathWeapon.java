...
public class SoundEffectBreathWeapon {
  ...
  private WeaponSoundUpdateLinkLegacy weaponSoundUpdateLinkLegacy;

  public SoundEffectBreathWeapon(SoundController i_soundController, WeaponSoundUpdateLinkLegacy i_weaponSoundUpdateLink) {
    soundController = i_soundController;
    weaponSoundUpdateLinkLegacy = i_weaponSoundUpdateLink;
  }
  ...
  public void performTick(EntityPlayerSP entityPlayerSP, EntityTameableDragon dragon) {
    ...
    boolean keepPlaying = weaponSoundUpdateLinkLegacy.refreshWeaponSoundInfo(weaponSoundInfo);
    if (!keepPlaying) {
      setAllStopFlags();
      return;
    }
   ...
   */
  public interface WeaponSoundUpdateLinkLegacy {
