...
public class DragonMounts {
    ...
    @NetworkWrapper({MessageDragonInventory.class, MessageDragonWhistle.class, MessageDragonGuiSit.class, MessageDragonGuiLock.class, MessageDragonTeleport.class, MessageDragonExtras.class})
